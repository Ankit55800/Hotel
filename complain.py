...
#==============================================================TableFrame=========================================================================================
        ...
        TableFrame=LabelFrame(self.root,bd=2,relief=RIDGE,text="Complaints",font=("times new roman",14,"bold"),padx=2)
...
#===================================================================Show Data Table===================================================================================
        ...
        self.Empdetails_table=ttk.Treeview(detailsTable,column=("fName","lName","gender","phone","email","complain"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.Empdetails_table.heading("complain",text="Complaints")
        ...
        self.Empdetails_table.column("complain",width=100)
